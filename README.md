...
Below is a simplified keymap. Missing are all the Adaptive layers, and a lot of combos are removed to make this more legible. Yes, it's a crowded little keyboard, but gosh, it sure is comfy!
